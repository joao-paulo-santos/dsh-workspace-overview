...
window.__ModuleLoader__.load({ id: 'dsh-workspace-overview', factory: (require) => {
  ...
  const OverviewTab = (props) => {
    ...
    return React.createElement('div', { className: 'wsov-page' + (active !== 'overview' ? ' wsov-page-wide' : '') },
      strip,
  ...
  module.exports = {
    ...
    apply(ctx) {
      ...
      tag.textContent = '.wsov-page{flex:1 1 auto;min-height:0;height:100%;max-width:720px;width:100%;margin:0 auto;padding:24px 32px 0;box-sizing:border-box;display:flex;flex-direction:column;color:var(--dsw-alias-label-primary)}'
        + '.wsov-page-wide{max-width:1100px}'
